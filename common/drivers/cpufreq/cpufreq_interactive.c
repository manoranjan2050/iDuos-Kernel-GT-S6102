 ...
 *
 * Mod by Irfan Bagus (irfanbagus@gmail.com)
 * Use kallsyms_lookup_name to find nr_running address
 *
 */
...
typedef unsigned long(*nr_running_type)(void);
static nr_running_type nr_running_addr = 0;
...
static void cpufreq_interactive_timer(unsigned long data)
{
	...
	if (!timer_pending(t) && (*nr_running_addr)() > 0) {
